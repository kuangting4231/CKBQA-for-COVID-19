...
def build_word_index():
    ...
    if not os.path.exists(word_embedding_file):
        print('word embedding file does not exist, please check your file path ', src_vocab_file)
        return
...
def get_src_vocab_size():
    ...
    '''
    size = 0
    print('src_vocab_file:', src_vocab_file)
...
def load_word2vec_embedding(vocab_size):
    ...
    f = open(word_embedding_file, mode='rb')
